...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            axios.get(`http://localhost/Penjadwalan/Penjadwalan-Backend/public/api/jam/${route.params.kode}`)
            .then(response => {
        ...
        function update() {
            ...
            axios.put(`http://localhost/Penjadwalan/Penjadwalan-Backend/public/api/jam/${route.params.kode}`, {
                range_jam: range_jam,
                aktif: aktif
            }).then(() => {
